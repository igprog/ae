     ...
     //   string ApplicationSettingsPathForSave = ConfigurationManager.AppSettings["ApplicationSettingsPathForSave"];
        ...
        public ApplicationSettings()
        {
            ...
            XmlDocument document = new XmlDocument();
               ...
               document.Load(SiteUrl + ApplicationSettingsPath);  //   LOKALNO     
          //  document.Load(ApplicationSettingsPath);   //NA PRODUKCIJI
            ...
            foreach (XmlNode node in infoNodeList)
            {
                ...
                _AdditionalGSM1 = node.SelectSingleNode("AdditionalGSM1").InnerText;
                _Site = node.SelectSingleNode("Site").InnerText;
                _SiteURL = node.SelectSingleNode("SiteURL").InnerText;
                _MyEmail = node.SelectSingleNode("MyEmail").InnerText;
        ...
        public string AdditionalGSM1
        {
            get { return _AdditionalGSM1; }
        }
